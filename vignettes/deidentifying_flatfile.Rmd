...
path if they are not in the working directory.
...
A second Pentacam example where the values are separated by semicolons
...
1. the variable containing the patient's MRN is usually "MRN" (but sometimes "MRN0");
